    ...
    <div class="page-header">
        <div class="page-header-left">
            ...
            <div class="page-header-content">
                <h1 class="page-title">Daftar Seminar</h1>
                <p class="page-subtitle">Temukan seminar yang sesuai dengan minat dan kebutuhan Anda</p>
            </div>
        </div>
        <div class="page-header-actions">
            <span class="badge bg-pink">{{ $seminars->total() }} Seminar Tersedia</span>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="seminar-meta">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <span class="small">{{ $seminar->formatted_datetime }}</span>
                        </div>
                    </div>
                </div>
