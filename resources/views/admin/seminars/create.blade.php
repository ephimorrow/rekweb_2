        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0">Tambah Seminar Baru</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.seminars.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                                ...
                                                <option value="skripsi" {{ old('type') == 'skripsi' ? 'selected' : '' }}>Skripsi</option>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="photoPreview" class="text-center p-3 border rounded">
                                            ...
                                            <p class="small text-muted mb-0">Preview foto akan muncul di sini</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-pink">Simpan Seminar</button>
                        </div>
                    </form>
                </div>
            </div>
